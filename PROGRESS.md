...
_이 파일은 `backlog.json`으로부터 자동 생성됩니다. 직접 편집하지 마세요. (생성: 2026-09-17T16:30:04.604Z)_

프로젝트: **ClaudeBridge**

## 요약

전체 53개 작업 — 완료 52, 미결/보류 1
...
| T-052 | 완료 | /status 쿼터 동기화 주기 단축(5분→1분, 안전 검사는 유지) |
...
| T-050 | 완료 | 백로그 테이블 ID/상태/카테고리 칼럼 항상 한 줄 표시 |
| T-051 | 완료 | 백로그 화면 새로고침 버튼 + 모바일 pull-to-refresh |
| T-053 | 완료 | 새로고침 버튼을 설정 제외 전체 페이지로 확장 |
