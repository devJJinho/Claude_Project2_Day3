...
_이 파일은 `backlog.json`으로부터 자동 생성됩니다. 직접 편집하지 마세요. (생성: 2026-09-17T15:32:53.456Z)_

프로젝트: **ClaudeBridge**

## 요약

전체 49개 작업 — 완료 47, 미결/보류 1, 진행 중 1
...
| T-048 | 완료 | 대기 질문·권한 탭에 backlog needs_info 항목 통합 표시 |
| T-049 | 진행 중 | 모바일 반응형 레이아웃 수정: 계정정보 위치, 테이블 가로 스크롤 |
