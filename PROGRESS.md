...
_이 파일은 `backlog.json`으로부터 자동 생성됩니다. 직접 편집하지 마세요. (생성: 2026-09-17T04:31:59.138Z)_

프로젝트: **ClaudeBridge**

## 요약

전체 47개 작업 — 완료 42, needs_info 3, 미결/보류 2
...
| ID | 상태 | 제목 |
|---|---|---|
| T-036 | 미결/보류 | E2E 테스트: AskUserQuestion 1건 웹 응답→tmux 주입 성공 확인 |
